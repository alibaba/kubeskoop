...
var (
	...
	conntrackMetrics = []probe.LegacyMetric{
		{
			Name: Found,
			Help: "The total number of tracked connections found in the conntrack table.",
		},
		{
			Name: Invalid,
			Help: "The total number of invalid connections encountered.",
		},
		{
			Name: Ignore,
			Help: "The total number of connections that were ignored by the conntrack module.",
		},
		{
			Name: Insert,
			Help: "The total number of connections inserted into the conntrack table.",
		},
		{
			Name: InsertFailed,
			Help: "The total number of failed attempts to insert a connection into the conntrack table.",
		},
		{
			Name: Drop,
			Help: "The total number of connections dropped from the conntrack table.",
		},
		{
			Name: EarlyDrop,
			Help: "The total number of connections dropped early before they were fully established.",
		},
		{
			Name: Error,
			Help: "The total number of errors encountered while managing connections in the conntrack table.",
		},
		{
			Name: SearchRestart,
			Help: "The total number of times the search for a connection entry was restarted.",
		},
		{
			Name: Entries,
			Help: "The current number of connections tracked in the conntrack table.",
		},
		{
			Name: MaxEntries,
			Help: "The maximum number of entries allowed in the conntrack table.",
		},
	}
)
